...
public class TileEntityMobSpawner extends TileEntity {
    ...
    public void b() {
        this.h = this.g;
        if (this.a()) {
            double d1 = (double) ((float) this.b + this.a.m.nextFloat());
            double d2 = (double) ((float) this.c + this.a.m.nextFloat());
            double d3 = (double) ((float) this.d + this.a.m.nextFloat());
            ...
            if (this.e > 0) {
                ...
                for (int i = 0; i < b1; ++i) {
                    ...
                    if (entityliving != null) {
                        double d4 = (double) this.b + (this.a.m.nextDouble() - this.a.m.nextDouble()) * 4.0D;
                        double d5 = (double) (this.c + this.a.m.nextInt(3) - 1);
                        double d6 = (double) this.d + (this.a.m.nextDouble() - this.a.m.nextDouble()) * 4.0D;

                        entityliving.c(d4, d5, d6, this.a.m.nextFloat() * 360.0F, 0.0F);
                        if (entityliving.a()) {
                            this.a.a((Entity) entityliving);

                            for (int k = 0; k < 20; ++k) {
                                d1 = (double) this.b + 0.5D + ((double) this.a.m.nextFloat() - 0.5D) * 2.0D;
                                d2 = (double) this.c + 0.5D + ((double) this.a.m.nextFloat() - 0.5D) * 2.0D;
                                d3 = (double) this.d + 0.5D + ((double) this.a.m.nextFloat() - 0.5D) * 2.0D;
                                this.a.a("smoke", d1, d2, d3, 0.0D, 0.0D, 0.0D);
                                this.a.a("flame", d1, d2, d3, 0.0D, 0.0D, 0.0D);
                            }
