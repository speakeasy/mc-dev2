                    ...
                    if (s.toLowerCase().startsWith("op ")) {
                        ...
                        if (s.toLowerCase().startsWith("ban ")) {
                            ...
                            for (int i = 0; i < this.f.b.size(); ++i) {
                                ...
                                if (entityplayermp1.aw.equalsIgnoreCase(s2)) {
                                    entityplayermp = entityplayermp1;
                                }
                            }

                            if (entityplayermp != null) {
                                entityplayermp.a.a("Kicked by admin");
                                this.a(s1, "Kicking " + entityplayermp.aw);
                            } else {
                            ...
                            if (s.toLowerCase().startsWith("tp ")) {
                                ...
                                if (entityplayermp2 != null) {
                                    try {
                                        ...
                                        if (Item.c[j] != null) {
                                            this.a(s1, "Giving " + entityplayermp2.aw + " some " + j);
                                            int k = 1;
                                            ...
                                            entityplayermp2.b(new ItemStack(j, k));
                                        } else {
