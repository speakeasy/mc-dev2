...
public class World implements IBlockAccess {
    ...
    public int a(int i, int j, int k, boolean flag) {
        if (i >= -32000000 && k >= -32000000 && i < 32000000 && k <= 32000000) {
            ...
            if (flag) {
                l = this.a(i, j, k);
                if (l == Block.al.bi || l == Block.aB.bi) {
    ...
    public void a(EnumSkyBlock enumskyblock, int i, int j, int k, int l) {
        if (!this.q.c || enumskyblock != EnumSkyBlock.a) {
            if (this.e(i, j, k)) {
    ...
    public void a(Entity entity, String s, float f1, float f2) {
        for (int i = 0; i < this.r.size(); ++i) {
            ((IWorldAccess) this.r.get(i)).a(s, entity.p, entity.q - (double) entity.G, entity.r, f1, f2);
        }
    }
        ...
        for (int k1 = i; k1 < j; ++k1) {
            for (int l1 = k; l1 < l; ++l1) {
                for (int i2 = i1; i2 < j1; ++i2) {
                    ...
                    if (j2 == Block.as.bi || j2 == Block.D.bi || j2 == Block.E.bi) {
                        return true;
                    }
                }
            }
    ...
    protected void g() {
        ...
        while (iterator.hasNext()) {
            ...
            if (this.L == 0) {
                ...
                l += i;
                j1 += j;
                if (l1 == 0 && this.h(l, k1, j1) <= this.l.nextInt(8) && this.a(EnumSkyBlock.a, l, k1, j1) <= 0) {
            ...
            for (k = 0; k < 80; ++k) {
                ...
                if (Block.o[b2]) {
                    Block.n[b2].a(this, j1 + i, l1, k1 + j, this.l);
                }
            }
        }
    }
