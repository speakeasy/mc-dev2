...
public class EntityPainting extends Entity {
    ...
    public void a(int i) {
        ...
        float f1 = (float) this.b.z;
        float f2 = (float) this.b.A;
        float f3 = (float) this.b.z;
        ...
        f2 /= 32.0F;
        f3 /= 32.0F;
        float f4 = (float) this.ae + 0.5F;
        float f5 = (float) this.af + 0.5F;
        float f6 = (float) this.ag + 0.5F;
        float f7 = 0.5625F;
        ...
        this.v.c((double) (f4 - f1 - f8), (double) (f5 - f2 - f8), (double) (f6 - f3 - f8), (double) (f4 + f1 + f8), (double) (f5 + f2 + f8), (double) (f6 + f3 + f8));
    }
    ...
    public void b_() {
        if (this.ad++ == 100 && !this.b()) {
            this.ad = 0;
            this.j();
            this.h.a((Entity) (new EntityItem(this.h, this.l, this.m, this.n, new ItemStack(Item.aq))));
        }
    }
