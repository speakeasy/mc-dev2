...
public class EntityTrackerEntry {
    ...
    public void a(List list) {
        ...
        if (this.m++ % this.d == 0) {
            ...
            if (this.t) {
                double d1 = this.a.s - this.j;
                double d2 = this.a.t - this.k;
                double d3 = this.a.u - this.l;
                double d4 = 0.02D;
    ...
    public void a(EntityPlayerMP entityplayermp) {
        if (entityplayermp != this.a) {
            double d1 = entityplayermp.p - (double) (this.e / 32);
            double d2 = entityplayermp.r - (double) (this.g / 32);

            if (d1 >= (double) (-this.c) && d1 <= (double) this.c && d2 >= (double) (-this.c) && d2 <= (double) this.c) {
                if (!this.o.contains(entityplayermp)) {
                    this.o.add(entityplayermp);
                    entityplayermp.a.b(this.b());
                    if (this.b) {
                        entityplayermp.a.b((Packet) (new Packet18ArmAnimation(this.a, 2)));
                    }
