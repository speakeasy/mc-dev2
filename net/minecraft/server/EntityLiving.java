...
public class EntityLiving extends Entity {
    ...
    public boolean d_() {
        ...
        return this.l.a(i, j, k) == Block.aG.bi || this.l.a(i, j + 1, k) == Block.aG.bi;
    }
    ...
    public void D() {
        if (this.b > 0) {
            double d1 = this.p + (this.c - this.p) / (double) this.b;
            double d2 = this.q + (this.d - this.q) / (double) this.b;
            double d3 = this.r + (this.e - this.r) / (double) this.b;

            double d4;

            for (d4 = this.f - (double) this.v; d4 < -180.0D; d4 += 360.0D) {
                ;
            }
            ...
            this.v = (float) ((double) this.v + d4 / (double) this.b);
    ...
    protected void c() {
        ...
        if (this.aj != null) {
            ...
            if (this.ak-- <= 0 || this.aj.F || this.aj.b((Entity) this) > (double) (f1 * f1)) {
                this.aj = null;
            }
        } else {
