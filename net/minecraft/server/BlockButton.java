...
public class BlockButton extends Block {
    ...
    public void a(IBlockAccess iblockaccess, int i, int j, int k) {
        ...
        if (i1 == 1) {
            this.a(0.0F, f1, 0.5F - f3, f4, f2, 0.5F + f3);
        } else if (i1 == 2) {
            this.a(1.0F - f4, f1, 0.5F - f3, 1.0F, f2, 0.5F + f3);
        } else if (i1 == 3) {
            this.a(0.5F - f3, f1, 0.0F, 0.5F + f3, f2, f4);
        } else if (i1 == 4) {
            this.a(0.5F - f3, f1, 1.0F - f4, 0.5F + f3, f2, 1.0F);
        }
    }
