...
public class EntityFish extends Entity {
    ...
    public void b_() {
        super.b_();
        if (this.ap > 0) {
            double d1 = this.p + (this.aq - this.p) / (double) this.ap;
            double d2 = this.q + (this.ar - this.q) / (double) this.ap;
            double d3 = this.r + (this.as - this.r) / (double) this.ap;

            double d4;

            for (d4 = this.at - (double) this.v; d4 < -180.0D; d4 += 360.0D) {
                ;
            }
            ...
            this.v = (float) ((double) this.v + d4 / (double) this.ap);
