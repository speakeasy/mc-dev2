...
public class MapGenCaves extends MapGenBase {
                    ...
                    for (j3 = k1; !flag2 && j3 < l1; ++j3) {
                        for (int k3 = k2; !flag2 && k3 < l2; ++k3) {
                            for (int l3 = j2 + 1; !flag2 && l3 >= i2 - 1; --l3) {
                                i3 = (j3 * 16 + k3) * 128 + l3;
                                if (l3 >= 0 && l3 < 128) {
                                    if (abyte[i3] == Block.B.bc || abyte[i3] == Block.C.bc) {
                                        flag2 = true;
                                    }
                            ...
                            for (i3 = k2; i3 < l2; ++i3) {
                                ...
                                for (int j4 = j2 - 1; j4 >= i2; --j4) {
                                    ...
                                    if (d15 > -0.7D && d13 * d13 + d15 * d15 + d14 * d14 < 1.0D) {
                                        ...
                                        if (b1 == Block.u.bc || b1 == Block.w.bc || b1 == Block.v.bc) {
                                            if (j4 < 10) {
                                                abyte[i4] = (byte) Block.D.bc;
                                            } else {
                                                abyte[i4] = 0;
                                                if (flag3 && abyte[i4 - 1] == Block.w.bc) {
                                                    abyte[i4 - 1] = (byte) Block.v.bc;
                                                }
                                            }
                                        }
                                    }
    ...
    protected void a(World world, int i, int j, int k, int l, byte[] abyte) {
        ...
        for (int j1 = 0; j1 < i1; ++j1) {
            ...
            double d2 = (double) this.b.nextInt(this.b.nextInt(120) + 8);
            ...
            for (int l1 = 0; l1 < k1; ++l1) {
                ...
                this.a(k, l, abyte, d1, d2, d3, f3, f1, f2, 0, 0, 1.0D);
            }
        }
    }
}
