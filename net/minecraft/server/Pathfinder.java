...
public class Pathfinder {
    ...
    public PathEntity a(Entity entity, Entity entity1, float f1) {
        return this.a(entity, entity1.l, entity1.v.b, entity1.n, f1);
    }
    ...
    private PathEntity a(Entity entity, double d1, double d2, double d3, float f1) {
        ...
        PathPoint pathpoint1 = this.a(MathHelper.b(d1 - (double) (entity.D / 2.0F)), MathHelper.b(d2), MathHelper.b(d3 - (double) (entity.D / 2.0F)));
