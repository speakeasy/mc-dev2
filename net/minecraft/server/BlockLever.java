...
public class BlockLever extends Block {
    ...
    public void a(IBlockAccess iblockaccess, int i, int j, int k) {
        ...
        if (l == 1) {
            this.a(0.0F, 0.2F, 0.5F - f1, f1 * 2.0F, 0.8F, 0.5F + f1);
        } else if (l == 2) {
            this.a(1.0F - f1 * 2.0F, 0.2F, 0.5F - f1, 1.0F, 0.8F, 0.5F + f1);
        } else if (l == 3) {
            this.a(0.5F - f1, 0.2F, 0.0F, 0.5F + f1, 0.8F, f1 * 2.0F);
        } else if (l == 4) {
            this.a(0.5F - f1, 0.2F, 1.0F - f1 * 2.0F, 0.5F + f1, 0.8F, 1.0F);
        } else {
            f1 = 0.25F;
