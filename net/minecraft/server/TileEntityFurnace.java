...
public class TileEntityFurnace extends TileEntity implements IInventory {
    ...
    public void a(NBTTagCompound nbttagcompound) {
        ...
        for (int i = 0; i < nbttaglist.b(); ++i) {
            ...
            if (b1 >= 0 && b1 < this.h.length) {
                this.h[b1] = new ItemStack(nbttagcompound1);
            }
        }
    ...
    public boolean a_(EntityPlayer entityplayer) {
        return this.a.l(this.b, this.c, this.d) != this ? false : entityplayer.d((double) this.b + 0.5D, (double) this.c + 0.5D, (double) this.d + 0.5D) <= 64.0D;
    }
}
