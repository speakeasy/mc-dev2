...
public class NetServerHandler extends NetHandler implements ICommandListener {
    ...
    public void a(Packet10Flying packet10flying) {
        ...
        if (this.j) {
            ...
            float f3 = 0.0625F;
            boolean flag = this.d.e.a(this.e, this.e.v.b().e((double) f3, (double) f3, (double) f3)).size() == 0;
            ...
            boolean flag2 = this.d.e.a(this.e, this.e.v.b().e((double) f3, (double) f3, (double) f3)).size() == 0;
    ...
    public void a(Packet14BlockDig packet14blockdig) {
        ...
        if (packet14blockdig.e == 0) {
            ...
            double d2 = this.e.l - ((double) i + 0.5D);
            double d3 = this.e.m - ((double) j + 0.5D);
            double d4 = this.e.n - ((double) k + 0.5D);
        ...
        if (s.toLowerCase().startsWith("/me ")) {
            ...
            if (s.toLowerCase().equalsIgnoreCase("/home")) {
                ...
                if (MinecraftServer.b.containsKey(this.e.aq)) {
                    ...
                    for (i = 0; i < 4; ++i) {
                        this.e.a(new ItemStack(Item.m, 1));
                    }
                }
                ...
                if (MinecraftServer.b.containsKey(this.e.aq)) {
                    ...
                    for (i = 0; i < 4; ++i) {
                        this.e.a(new ItemStack(Block.z, 1));
                    }
                }
            } else {
                String s1;
