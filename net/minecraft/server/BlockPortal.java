...
public class BlockPortal extends BlockBreakable {
    ...
    public boolean a_(World world, int i, int j, int k) {
        ...
        if (b1 == b2) {
            ...
            for (l = 0; l < 2; ++l) {
                for (i1 = 0; i1 < 3; ++i1) {
                    world.d(i + b1 * l, j + i1, k + b2 * l, Block.bf.bi);
                }
            }
    ...
    public void b(World world, int i, int j, int k, int l) {
        ...
        if (world.a(i, i1 - 1, k) != Block.aq.bi) {
            world.d(i, j, k, 0);
        } else {
            int j1;
            ...
            if (j1 == 3 && world.a(i, i1 + j1, k) == Block.aq.bi) {
                ...
                if (flag && flag1) {
                    world.d(i, j, k, 0);
                } else if ((world.a(i + b1, j, k + b2) != Block.aq.bi || world.a(i - b1, j, k - b2) != this.bi) && (world.a(i - b1, j, k - b2) != Block.aq.bi || world.a(i + b1, j, k + b2) != this.bi)) {
                    world.d(i, j, k, 0);
                }
            } else {
                world.d(i, j, k, 0);
