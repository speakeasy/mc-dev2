...
public class EntityTNTPrimed extends Entity {
    ...
    public EntityTNTPrimed(World world, float f1, float f2, float f3) {
        ...
        this.o = (double) (-MathHelper.a(f4 * 3.1415927F / 180.0F) * 0.02F);
        this.p = 0.20000000298023224D;
        this.q = (double) (-MathHelper.b(f4 * 3.1415927F / 180.0F) * 0.02F);
        this.H = false;
        this.a = 80;
        this.i = (double) f1;
        this.j = (double) f2;
    ...
    private void b() {
        ...
        this.h.a((Entity) null, this.l, this.m, this.n, f1);
    }
