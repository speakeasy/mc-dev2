...
public class EntitySlime extends EntityLiving implements IMobs {
    ...
    public void b_() {
        ...
        if (this.A && !flag) {
            for (int i = 0; i < this.c * 8; ++i) {
                ...
                float f2 = this.V.nextFloat() * 0.5F + 0.5F;
    ...
    public void l() {
        if (this.c > 1 && this.aP == 0) {
            for (int i = 0; i < 4; ++i) {
                ...
                entityslime.c(this.p + (double) f1, this.q + 0.5D, this.r + (double) f2, this.V.nextFloat() * 360.0F, 0.0F);
    ...
    public void a(EntityPlayer entityplayer) {
        if (this.c > 1 && this.g(entityplayer) && (double) this.a((Entity) entityplayer) < 0.6D * (double) this.c && entityplayer.a(this, this.c)) {
