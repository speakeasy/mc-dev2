...
public class EntitySlime extends EntityLiving implements IMobs {
    ...
    public void b_() {
        ...
        if (this.w && !flag) {
            for (int i = 0; i < this.ad * 8; ++i) {
                float f1 = this.R.nextFloat() * 3.1415927F * 2.0F;
                float f2 = this.R.nextFloat() * 0.5F + 0.5F;
                float f3 = MathHelper.a(f1) * (float) this.ad * 0.5F * f2;
                float f4 = MathHelper.b(f1) * (float) this.ad * 0.5F * f2;

                this.h.a("slime", this.l + (double) f3, this.v.b, this.n + (double) f4, 0.0D, 0.0D, 0.0D);
            }
    ...
    public void j() {
        if (this.ad > 1 && this.aM == 0) {
            for (int i = 0; i < 4; ++i) {
                ...
                float f2 = ((float) (i / 2) - 0.5F) * (float) this.ad / 4.0F;
                EntitySlime entityslime = new EntitySlime(this.h);

                entityslime.c(this.ad / 2);
                entityslime.c(this.l + (double) f1, this.m + 0.5D, this.n + (double) f2, this.R.nextFloat() * 360.0F, 0.0F);
    ...
    public void a(EntityPlayer entityplayer) {
        if (this.ad > 1 && this.g(entityplayer) && (double) this.a((Entity) entityplayer) < 0.6D * (double) this.ad && entityplayer.a(this, this.ad)) {
