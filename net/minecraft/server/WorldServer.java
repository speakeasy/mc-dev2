...
public class WorldServer extends World {
    ...
    public boolean A;
    private boolean B;
    private SpawnerAnimals C = new SpawnerMonsters(this, 200, IMobs.class, new Class[] { EntityZombie.class, EntitySkeleton.class, EntityCreeper.class, EntitySpider.class, EntitySlime.class});
    private SpawnerAnimals D = new SpawnerAnimals(15, EntityAnimals.class, new Class[] { EntitySheep.class, EntityPig.class, EntityCow.class, EntityChicken.class});
